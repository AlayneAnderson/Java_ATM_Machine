//Alayne Anderson started 2/27/22
//ATM Machine virtual assignment
...
public class ATM {
    ...
    //no-arg constructor
    public ATM(){
        userAuthenticated = false; //no auth user to start
        ...
        bankDatabase = new BankDatabase(); //create DB
    }
    ...
    void startlogin(){
        ...
        suthenticate check = new authenticate();
    ...
    //set userAuthenticated to boolean val returned by DB
    public void authenticateuser(int pin){
        userAuthenticated = bankDababase.authenticateUser(pin);
        ...
        if(userAuthenticated) {
            ...
            screen.messageJLabel13.setText("Invalid account number or PIN. Please try again.");
    }
